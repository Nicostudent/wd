...
const [active, setActive] = useState(false)
  ...
  return (
    <div>
        ...
        {active && (
              <div className="flex flex-col fixed w-full items-center gap-12 py-4 justify-center font-Dosis text-lg bg-slate-400 opacity-90 text-white font-bold rounded left-0 z-50">
