...
export const NavBar = () => {
  ...
  return (
    <div className="flex items-center gap-12 justify-center font-Dosis text-lg ">
      ...
      {showUpButton && (    
        <div className="flex justify-center items-center rounded border border-slate-800 text-bold fixed bottom-10 right-10 w-16 h-16 cursor-pointer text-center bg-slate-50 hover:bg-slate-200 hover:shadow-sm">
